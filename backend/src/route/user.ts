...
// このやり方はダサい。
// sharedという名前の独立したnpm packageを作ったうえで
// } from "@shared/schema" と書くべき。
// それはわかっているが、あとでやることにしよう。
// https://zenn.dev/logbuild/articles/2b3f650389eade
// とかを参考にして。
...
// 最終的にroutes変数をexportする。backend/src/index.tsはAPIクライアントを
